...
public class JumpTaskCmd implements Command<Void> {
    ...
    public void jump() {
        ...
        FlowElement targetElement = ProcessDefinitionUtil.getProcess(currentTask.getProcessDefinitionId()).getFlowElement(this.targetElementId);
        ...
        historyManager.recordTaskEnd(currentTask, currentExecution, this.reason);
        historyManager.recordActivityEnd(currentExecution, this.reason);
    }


    public JumpTaskCmd(String targetElementId, String taskId,String reason) {
